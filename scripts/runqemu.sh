...
# reaches runqemu unchanged. To boot the default image with more RAM, run:
#
#     scripts/runqemu.sh gardena-image-foss-bnw qemuparams="-m 512"
...
#
# The 128 MB of RAM match the gateway hardware. Without them, runqemu would
# hand out its own default of 256 MB.
exec runqemu "${conf}" ext4 slirp nographic qemuparams="-m 128" "$@"
